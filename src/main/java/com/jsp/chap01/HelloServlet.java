...
// 이 클래스 역할: http 요청 응답 처리에서 필요한 공통적인 부분을 쉽게 해결해 주는 자바 API를 이용한 클래스.
@WebServlet("/hello") // 우리 웹서버에 /hello라는 URL로 요청이 오면 이 서블릿을 실핼시켜라!
public class HelloServlet extends HttpServlet { // HttpServlet을 상속 받습니다.
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.setContentType("text/html");  //컨텐츠 파일 세팅 해줘야함
        ...
        w.flush(); // 브라우저로 지금까지 작성한 내용들을 내보낸 후 멤리 공간을 비우기.
        w.close();
    }
}
